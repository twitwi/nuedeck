...
export default () => ({
  ...
  /*async*/ enrichGeneratedSlidesHeader({type, headerLines}, ...more) { log('enrichSlides', ...more) }, // called by slide generator, to enrich the header, especially to allow to not parse some slides
